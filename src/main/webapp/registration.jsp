            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label>Lastname:</label> <input type="text"
                                                    class="form-control lastname" id="userLastname" placeholder="Lastname"
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label>Username:</label> <input type="text"
                                                    class="form-control username" id="userUsername"
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="pwd">Password:</label> <input type="password"
                                                              class="form-control text-width pwd" id="userPassword"
            ...
            <div class="">
                ...
                <div class="form-group">
                    <label for="hobbies">Hobby:</label> <input type="text"
                                                               class="form-control text-width hobbies" id="userHobbies"
                                                               placeholder="Hobbies"
                                                               name="userHobbies"
                ...
                <div class="">
                    ...
                    <div class="form-group">
                        <label for="dob">Date Of Birth:</label> <input type="date"
                                                                       class="form-control text-width dob" id="userDOB"
...
%>
                        ...
                        <div class="row form-row ">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Lastname:</label> <input type="text"
                                                                    class="form-control lastname" id="userLastname"
                        ...
                        <div class="row form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="cpwd">Confirm Password:</label> <input
                                        type="password" class="form-control text-width cpwd" id="userConfirmPassword"
