 ...
 *   https://datatables.net/download/#bs4/dt-1.13.5/b-2.4.1/b-colvis-2.4.1/b-print-2.4.1/date-1.5.1/fh-3.4.0/r-2.5.0/sl-1.7.0
 *
 * Included libraries:
 *   DataTables 1.13.5, Buttons 2.4.1, Column visibility 2.4.1, Print view 2.4.1, DateTime 1.5.1, FixedHeader 3.4.0, Responsive 2.5.0, Select 1.7.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.13.5/b-2.4.1/b-colvis-2.4.1/b-print-2.4.1/date-1.5.1/fh-3.4.0/r-2.5.0/sl-1.7.0",
